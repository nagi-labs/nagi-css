...
```vue
<template><dialog class="confirm-dialog" :open="open"><header class="header"><h2 class="title">Delete?</h2></header><p class="text">This cannot be undone.</p><div class="actions"><button class="button">Cancel</button></div></dialog></template>
<style scoped>.confirm-dialog { > .header { > .title {} } > .text {} > .actions { > .button {} } }</style>
```
